...
const ProjectCard: React.FC<ProjectCardProps> = ({ projectName, img, desc, link }) => {
    return (
        <div className='mr-3 embla__slide relative bg-secondary rounded-2xl  ' >
            <Image className='object-cover rounded-2xl absolute lg:object-contain ' src={img} alt='project' width={100} height={100} />
